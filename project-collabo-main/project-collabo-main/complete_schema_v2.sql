...
-- ============================================================================
-- CRITICAL FIXES FOR REGISTRATION AND AUTH
-- ============================================================================

-- 1. Fix User Registration (Use Trigger instead of Policy)
-- Drop the restrictive policy that fails during signup
DROP POLICY IF EXISTS "Users can insert own profile" ON public.users;

-- Create the Trigger to handle new user creation automatically
...
-- Ensure users can view/update their profiles
